...
def test_add_new_pet_with_valid_data(name='Петя', animal_type='питон', age='14', pet_photo='petya.jpeg'):
...
# 2
def test_add_photo_to_pet_with_valid_data(pet_photo='petya.jpeg'):
